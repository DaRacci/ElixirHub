...
//            .withPermission(cloud.commandframework.permission.Permission.of("terix.target.others"))
//            .withAliases("p")
...
//            this.registerCopy(
//                "wand",
//                Description.of("Gives the tool to use for region editing."),
//            ) {
//                this.permission("elixirhub.region.wand")
//                this.mutate { it.flag(playerFlag) }
//                this.suspendingHandler(this@CommandService::handleRegionWand)
//
//            }
//        }
//
...
//    }
//
//    private fun handleRegionWand(context: CommandContext<CommandSender>) {
//
//    }
//
